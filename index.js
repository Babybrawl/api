...
// Utilisation de cors pour autoriser les requêtes provenant de http://localhost
app.use(cors({ origin: 'http://localhost' }));

// Middleware pour gérer les erreurs dans la récupération de l'historique des combats
async function recupererHistoriqueCombatJoueur(playerTag, apiKey) {
    ...
    try {
        ...
        throw new Error(`Erreur lors de la récupération de l'historique des combats: ${erreur.message}`);
    }
}

// Middleware pour récupérer les informations d'un joueur
async function getPlayerInfo(playerTag, apiKey) {
    ...
    try {
        ...
        throw new Error(`Erreur lors de la récupération des informations du joueur: ${erreur.message}`);
    }
}

// Middleware pour récupérer les informations d'un club
async function getClubInfo(clubTag, apiKey) {
    ...
    try {
        ...
        throw new Error(`Erreur lors de la récupération des informations du club: ${erreur.message}`);
    }
}
